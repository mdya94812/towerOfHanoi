            ...
            const nextMove = () => {
                ...
                const paths = [
                    ...
                    },
                    {
                        ...
                        controlY: topPosition,
                        duration: Math.abs(POLE_CONFIG.midPoints[to] - diskWidth / 2 - startX) / pixelSpeed
                    },
                    {
                        ...
                        duration: Math.abs(POLE_CONFIG.bottom - (stacks[to].length - 1) * 20 - 20 - topPosition) / pixelSpeed
                    }
                ];
            ...
            const createDisks = () => {
                ...
                for (let i = 0; i < nDisks && width > 20; i++) {
                    ...
                    Object.assign(disk.style, {
                        ...
                        top: `${Math.round(POLE_CONFIG.bottom - (stacks[0].length + 1) * 20)}px`
                    });
